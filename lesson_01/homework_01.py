...
total_trees = apple_trees + pear_trees + plums_trees
print(total_trees)
...
"""
temp_by_noon = 0 + 5
temp_afternoon = temp_by_noon - 10
...
total_present_theater_group = present_boys + present_girls
print(total_present_theater_group)
